...
def save_vocab(input_vocab, output_vocab):
    ...
    with open('./vocab/input_vocab.pickle', 'wb') as inp:
        pickle.dump(input_vocab, inp)
    with open('./vocab/output_vocab.pickle', 'wb') as out:
        pickle.dump(output_vocab, out)

def load_vocab():
    print("=> Loading Vocabulary")
    iv = None
    ov = None
    with open('./vocab/input_vocab.pickle', 'rb') as inp:
        iv = pickle.load(inp)
    with open('./vocab/output_vocab.pickle', 'rb') as out:
        ov = pickle.load(out)
    return iv, ov